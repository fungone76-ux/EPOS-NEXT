...
TASK_PROFILES: dict[LLMTask, LLMTaskProfile] = {
    ...
    LLMTask.AUDIT_NARRATION: LLMTaskProfile(
        ...
        system_instruction=(
            ...
            "rhetorical questions, challenges, refusals, opinions, normative statements, general "
            "principles, aphorisms, proverbs, or uncertainty as violations when consistent with "
            "that NPC's authorized reaction. Generic statements such as 'La fiducia è una "
            "questione delicata', 'Le azioni parlano più delle parole', or 'La fiducia si "
            "guadagna' are characterization or general principles, not unsupported NPC facts. "
            "If an NPCDialogueDraft invents a concrete, specific factual assertion about that "
            "NPC's past conduct, personal history, achievements, promises, events, other people, "
            "or an external world fact, classify it as unsupported_npc_fact unless separately "
            "grounded by authorized evidence. Example: 'Ho sempre agito con trasparenza' is "
            "unsupported_npc_fact without evidence of that history. Reserve "
            "unsupported_world_claim for WorldNarrationDraft or for dialogue that asserts an "
            "external world fact as objective truth. Report only concrete contradictions or "
            "genuinely invented factual claims, not harmless dialogue rhetoric or characterization."
        ),
    ),
