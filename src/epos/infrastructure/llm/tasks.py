...
TASK_PROFILES: dict[LLMTask, LLMTaskProfile] = {
    ...
    LLMTask.AUDIT_NARRATION: LLMTaskProfile(
        ...
        system_instruction=(
            ...
            "uncertainty as world claims when they are consistent with that NPC's authorized "
            ...
            "not factual world claims, and should produce no finding when supported by reaction "
            "tone/intent. By contrast, a statement such as 'Ho sempre agito con trasparenza' "
            "asserts unsupported past conduct and must be classified as unsupported_world_claim "
            "unless separate authorized evidence supports that history. Do classify unsupported "
            "factual assertions about past conduct, personal history, events, other people, or the "
            "world as unsupported_world_claim unless separately grounded by authorized evidence. "
            "Report only a concrete contradiction or genuinely invented factual claim, not harmless "
            "dialogue rhetoric or characterization."
        ),
    ),
